# RestAPIIngesttoSilver

This folder defines all source code for the 'RestAPIIngesttoSilver' pipeline:
...
* Take a look at the sample under "sample_users_restapiingesttosilver.py" to get familiar with the syntax.
